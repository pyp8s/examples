...
if __name__ == "__main__":
    ...
    """
        You can increment a non-initialised metric just like that.
        Because who would judge you? Nobody.
    """

    meh.inc("pyp8s_minimal", 1, hostname=FQDN)
